...
current goal:
Replacing probabilistic QM w deterministic geometry: D₄-projected E₈^ℤ[φ,ψ] lattice, Breather Monad Ω(t), zero-drift axiom, and φ/ψ exponents for constant-matching; assume 24 cells.
